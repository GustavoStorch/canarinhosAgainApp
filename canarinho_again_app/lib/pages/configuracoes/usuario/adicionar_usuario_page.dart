...
class ConfigAdicionarUsuarioPage extends StatelessWidget {
  const ConfigAdicionarUsuarioPage({Key? key}) : super(key: key);
      ...
      child: FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.inState(ConnectionState.done).hasData) {
            ...
            return Error404Page(
                error: "ConfigAdicionarUsuarioPage: ${snapshot.error}");
          }
  ...
  void _salvarUsuarioAsync() {
    ...
    app
        ...
        .create(usuario)
        .then((usuario) {
          MensagemSucesso("Um novo usuário foi adicionado com sucesso!");
